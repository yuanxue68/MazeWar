...
public class Point implements Serializable {
   ...
   * 
   * @param x
   *          Coordinate in the X-dimension.
   * @param y
   *          Coordinate in the Y-dimension.
   */
  ...
  /**
   * Create a new {@link Point} by moving from this one by a single unit in a
   * given {@Direction}. North corresponds to postive Y-movement.
   * East corresponds to postive X-movement. South corresponds to negative
   * Y-movement. West corresponds to negative X-movement.
   * 
   * @return A new {@link Point} one unit away from this one in the given
   *         {@link Direction}.
   */
