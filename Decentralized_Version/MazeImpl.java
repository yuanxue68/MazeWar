...
public class MazeImpl extends Maze implements Serializable, ClientListener,
   ...
   * 
   * @param point
   *          Treat the {@link Point} as a magintude specifying the size of the
   *          maze.
   * @param seed
  ...
  /**
   * Listen for notifications about action performed by {@link Client}s in the
   * maze.
   * 
   * @param c
  ...
  private synchronized void set_flag(Collection deadPrj)
  {
  ...
  /**
   * A map between {@link Client}s and {@link DirectedPoint}s locating them in
   * the {@link Maze}.
   */
  ...
  /**
   * Generate a notification to listeners that a {@link Client} has been added.
   * 
   * @param c
  ...
  private class CellImpl extends Cell implements Serializable {
    ...
    /**
     * The contents of the {@link Cell}. <code>null</code> indicates that it is
     * empty.
     */
    private Object contents = null;

    /**
     * Helper function to convert a {@link Direction} into an array index for
     * easier access.
     * 
     * @param d
    ...
    /**
     * Has this {@link Cell} been visited in the process of recursviely building
     * the {@link Maze}?
     * 
     ...
     * 
     * @param contents
     *          Object to place in the {@link Cell}. Use <code>null</code> if
