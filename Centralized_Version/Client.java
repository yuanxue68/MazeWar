...
public abstract class Client {
  ...
  /**
   * Inform the {@link Client} that it has been taken out of the {@link Maze} in
   * which it is located. The {@link Client} must already be registered with a
   * {@link Maze} before this can be called.
   */
  ...
  /**
   * The maze where the client is located. <code>null</code> if not presently in
   * a maze.
   */
