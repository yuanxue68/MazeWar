...
public abstract class Maze {
   ...
   * 
   * @return A {@link Point} where the method <code>getX</code> returns the
   *         maximum X coordintate, and the method <code>getY</code> returns the
   ...
   * 
   * @return <code>true</code> if the point lies within the {@link Maze},
   *         <code>false</code> otherwise.
   */
  public abstract boolean checkBounds(Point point);

  /**
   * Obtain the {@link Cell} corresponding to a given {@link Point} in the
   * {@link Maze}.
   * 
   * @param point
   ...
   * 
   * @param client
   *          {@link Client} to be added to the {@link Maze}.
   */
   ...
   * 
   * @param client
   *          {@link Client} to be removed.
   */
  public abstract void removeClient(Client client);

  /**
   * Find out where a specified {@link Client} is located in the {@link Maze}.
   * 
   * @param client
   *          The {@link Client} being located.
   ...
   * 
   * @param client
   *          The {@link Client} being queried.
   * @return The orientation of the specific {@link Client} as a
   *         {@link Direction}.
   */
   ...
   * 
   * @param ml
   *          An object implementing the {@link MazeListener} interface.
   * */
