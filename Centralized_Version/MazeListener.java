...
/**
 * An interface for objects wishing to subscribe to notifications about events
 * occurring in a {@link Maze}.
 * 
...
public interface MazeListener {
  ...
  /**
   * Notification that client <code>source</code> has killed client
   * <code>target</code>.
   * 
   * @param source
   *          Client that fired the projectile.
   * @param target
   *          Client that was killed.
   */
