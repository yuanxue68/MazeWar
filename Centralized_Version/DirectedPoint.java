...
/**
 * An integral representation of a point in two dimensional space, with
 * direction. Sort of like a vector, but zero magnitude.
 * 
...
public class DirectedPoint extends Point {
   ...
   * 
   * @param x
   *          X-coordinate of this {@link DirectedPoint}.
   * @param y
   *          Y-coordinate of this {@link DirectedPoint}.
   * @param direction
   *          The {@link Direction} of this {@link DirectedPoint}.
   */
   ...
   * 
   * @param point
   *          Location of this {@link DirectedPoint}.
   * @param direction
   *          The {@link Direction} of this {@link DirectedPoint}.
   */
   ...
   * 
   * @param dp
   *          The {@link DirectedPoint} to copy from.
   */
